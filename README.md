...
- Download and install the [rpm
  file](https://github.com/Ralt/aergia/releases/download/1.0.1/aergia-1.0.1-1.x86_64.rpm)
  ([pgp signature](https://github.com/Ralt/aergia/releases/download/1.0.1/aergia_1.0.1-rpm.sig))
  if you're on Fedora/CentOS/Red Hat (x86~64~ only)
- Download and install the [deb
  file](https://github.com/Ralt/aergia/releases/download/1.0.1/aergia_1.0.1_amd64.deb)
  ([pgp signature](https://github.com/Ralt/aergia/releases/download/1.0.1/aergia_1.0.1-deb.sig))
